 ...
 * see [Client]'s KDoc for why it isn't generated by Nimba. It is the client's
 * sole identifier and is required going forward.
 */
data class CreateClientRequest(
    @field:NotBlank(message = "Le matricule est requis")
